...
data class Results (
    ...
    @SerializedName("launch_designator"                  ) var launchDesignator               : String?                = null,
    @SerializedName("status"                             ) var status                         : Status?                = Status(),
    @SerializedName("last_updated"                       ) var lastUpdated                    : String?                = null,
    @SerializedName("net"                                ) var net                            : String?                = null,
    @SerializedName("net_precision"                      ) var netPrecision                   : NetPrecision?          = NetPrecision(),
    @SerializedName("window_end"                         ) var windowEnd                      : String?                = null,
    @SerializedName("window_start"                       ) var windowStart                    : String?                = null,
    @SerializedName("image"                              ) var image                          : Image?                 = Image(),
    @SerializedName("infographic"                        ) var infographic                    : String?                = null,
